...
import ru.m0kita.profnotes.data.model.NewNote

class NewNotesAdapter(private val newNotes: List<NewNote>, private val context: Context) :
    RecyclerView.Adapter<NewNotesAdapter.NotesViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NotesViewHolder, position: Int) {
        ...
        holder.binding.rvUsersAvatars.adapter =
            NewNotesAvatarsAdapter(newNotes[position].usersAvatars, context)
    }
